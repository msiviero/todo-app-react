...
export const Checkbox = ({ id, checked, onChange }: CheckboxProps) => {
    ...
    return (
        <div className="flex items-center">
            <input id={`checkbox_${id}`} onChange={handleChange} readOnly checked={checked} type="checkbox" className="mx-4 appearance-none peer w-7 h-7 border-2 border-gray-300 rounded-sm bg-white" />
            {
                checked
